...
TEMPLATES = [
    {
        ...
        'DIRS': [],
        'APP_DIRS': True,  # ищет шаблоны в папках mainapp
        'OPTIONS': {
            'context_processors': [
...
# Добовляем сервер для отправки почты
...
with open('geekshop/vk.json', 'r') as f: VK = json.load(f)
